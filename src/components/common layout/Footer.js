...
const Footer = () => {
  return (
    <div>
      <div className='flex justify-between px-4 items-center border-t-2 border-slate-200 text-sm'>
      ...
      <div className="footer bg-[#ECE9E9] p-14 flex md:flex-row flex-col items-center md:space-x-6 space-y-4">
