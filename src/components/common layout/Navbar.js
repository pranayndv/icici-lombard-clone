  ...
  return (
    <div className='relative'>
      <div className="top-navbar  bg-[#F8F6F6] text-[13px] flex md:justify-between items-center md:px-10 py-1">
        <div className="left py-1 flex md:space-x-4 space-x-2 text-[13px]">
          <div className='flex items-center md:px-3 px-1 space-x-3'>
          ...
          <div className='flex items-center md:px-3 px-1 space-x-3 text-[13px]'>
        ...
        <button
            className="flex items-center px-1 md:hidden"
