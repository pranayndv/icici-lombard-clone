  ...
  <div className="flex space-x-1">
    {[...Array(5)].map((_, i) => (
      ...
      <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path id="Fill 1 Copy 3" fill-rule="evenodd" clip-rule="evenodd" d="M3.19833 11.8796C2.73881 12.1387 2.47366 11.9658 2.60596 11.4922L3.70141 7.57611L0.256635 4.98694C-0.159874 4.67395 -0.0586056 4.39377 0.48204 4.35998L4.96128 4.08715L6.63385 0.339075C6.83639 -0.113025 7.16361 -0.113025 7.3656 0.339075L9.03872 4.08715L13.518 4.35998C14.0586 4.39377 14.1599 4.67395 13.7434 4.98694L10.2991 7.57611L11.394 11.4922C11.5258 11.9658 11.2617 12.1387 10.8017 11.8796L6.99973 9.73228L3.19833 11.8796Z" fill="#FAA61A"/>
        </svg>
         :
         <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path id="Fill 1 Copy 4" fill-rule="evenodd" clip-rule="evenodd" d="M3.19833 11.8796C2.73881 12.1387 2.47366 11.9658 2.60596 11.4922L3.70141 7.57611L0.256635 4.98694C-0.159874 4.67395 -0.0586056 4.39377 0.48204 4.35998L4.96128 4.08715L6.63385 0.339075C6.83639 -0.113025 7.16361 -0.113025 7.3656 0.339075L9.03872 4.08715L13.518 4.35998C14.0586 4.39377 14.1599 4.67395 13.7434 4.98694L10.2991 7.57611L11.394 11.4922C11.5258 11.9658 11.2617 12.1387 10.8017 11.8796L6.99973 9.73228L3.19833 11.8796Z" fill="#CBCDCE"/>
</svg>
...
export default function ReviewCarousel() {
  ...
  return (
    <div className="max-w-6xl mx-auto text-center p-8">
      ...
      <p className="text-xl mb-6 flex justify-center items-center space-x-4">
