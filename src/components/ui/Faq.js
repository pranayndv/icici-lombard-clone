...
const Faq = () => {
  return (
    <div className="bg-[#00305B] py-10 px-4 md:px-14 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {faqItems.map((item, index) => (
          <div key={index} className="flex border border-[#065E9E] p-6 sm:p-7 rounded-md h-full">
            <div className="flex items-start pr-4">{item.icon}</div>
