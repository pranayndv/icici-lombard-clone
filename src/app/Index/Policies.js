...
const Policies = () => {
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">What are the benefits of buying car insurance online?</h2>
    <p className="font-mulish text-[16px]">
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">What are the various types of vehicles that I can insure online?</h2>
    <p className="font-mulish text-[16px]">You can insure a private car and two-wheeler online.</p>
  </div>

  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">How quickly can I buy/ renew car insurance online?</h2>
    <p className="font-mulish text-[16px]">
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">Are offline and online car insurance policies the same?</h2>
    <p className="font-mulish text-[16px]">
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">Where can I check my car insurance policy details?</h2>
    <p className="font-mulish text-[16px]">
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">What is an endorsement in car insurance?</h2>
    <p className="font-mulish text-[16px]">
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">Do I need a valid PUC to drive in India?</h2>
    <p className="font-mulish text-[16px]">
  ...
  <div className="flex gap-2 flex-col text-justify py-4">
    <h2 className="font-mulish text-[16px] font-semibold">Do I need to have a valid insurance policy to get my new vehicle registered?</h2>
    <p className="font-mulish text-[16px]">
