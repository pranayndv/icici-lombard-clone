...
const Inclusion = () => {
  ...
  return (
    <div className='p-4 sm:p-6 lg:p-16'>
      ...
      {activeLink === "/Inclusions" && (
        <div className='space-y-4 max-w-7xl mx-auto my-10 px-2 sm:px-6'>
      ...
      <div className='border-t-2 border-[#C9C9C9] text-[#B2B2B2] py-8 px-4 flex flex-col lg:flex-row items-center justify-center space-y-2 lg:space-y-0 lg:space-x-5 text-sm sm:text-base text-center'>
